...
<div class="login-box">
    ...
    ?>
  	<div class="login-box-body">
    	<p class="login-box-msg">Nhập mật khẩu mới</p>
    	...
    	<form action="password_new.php?code=<?php echo $_GET['code']; ?>&user=<?php echo $_GET['user']; ?>" method="POST">
          ...
          <div class="form-group has-feedback">
            ...
            <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
      		...
      		<div class="row">
    			<div class="col-xs-4">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" name="reset"><i class="fa fa-check-square-o"></i> Khôi phục</button>
        		</div>
      		</div>
    	</form>
  	</div>
