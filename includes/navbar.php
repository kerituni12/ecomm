  ...
  <nav class="navbar navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        <a href="index.php" class="navbar-brand"><b>Shop Tai Nghe</b></a>
      ...
      <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        ...
        <form method="POST" class="navbar-form navbar-left" action="search.php">
          <div class="input-group">
              <input type="text" class="form-control" id="navbar-search-input" name="keyword" placeholder="Tìm kiếm" required>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Bạn có <span class="cart_count"></span> mặt hàng(s) trong giỏ</li>
              <li>
